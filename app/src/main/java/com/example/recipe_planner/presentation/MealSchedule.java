...
public class MealSchedule extends Fragment {
     ...
     * @return A new instance of fragment MealSchedule.
     */

    public static MealSchedule newInstance(String param1, String param2) {
        MealSchedule fragment = new MealSchedule();
